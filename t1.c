...
int main()     
    {
        ...
        MPI_Isend( xlocal[maxn/size], maxn, MPI_DOUBLE, up_nbr, 0, MPI_COMM_WORLD, &req[0] );
        MPI_Irecv( xlocal[0], maxn, MPI_DOUBLE, down_nbr, 0, MPI_COMM_WORLD, &req[1] );
        ...
        MPI_Isend( xlocal[1], maxn, MPI_DOUBLE, down_nbr, 0, MPI_COMM_WORLD, &req[2] );
        MPI_Irecv( xlocal[maxn/size+1], maxn, MPI_DOUBLE, up_nbr, 0, MPI_COMM_WORLD, &req[3] );
